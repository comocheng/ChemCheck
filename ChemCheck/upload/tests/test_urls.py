...
class TestUrls(SimpleTestCase):
    ...
    def test_chemcheck_url(self):
        chemcheck_url = reverse_lazy('upload:chemcheck', args=['testuser', 1])
        print(resolve(chemcheck_url))
        self.assertEqual(resolve(chemcheck_url).func, chemcheck)
    
    def test_check_pdep_negative_A_url(self):
        check_pdep_negative_A_url = reverse_lazy('upload:check_pdep_negative_A', args=['testuser', 1])
    ...
    def test_check_negative_dup_rxns_negative_A_url(self):
        check_negative_dup_rxns_negative_A_url = reverse_lazy('upload:check_negative_dup_rxns_negative_A', args=['testuser', 1])
    ...
    def test_reaction_condition_url(self):
        reaction_condition_url = reverse_lazy('upload:reaction_condition', args=['testuser', 1])
    ...
    def test_collision_violation_check_url(self):
        collision_violation_check_url = reverse_lazy('upload:collision_violation', args=['testuser', 1])
