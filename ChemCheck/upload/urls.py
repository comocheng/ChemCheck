...
urlpatterns = [
    ...
    path('mechanism/<int:pk>/ace_mech/', views.ace_mech, name='ace-editor-mech'),
    path('mechanism/<int:pk>/ace_therm/', views.ace_therm, name='ace-editor-therm'),
    path('mechanism/<int:pk>/ace_trans/', views.ace_trans, name='ace-editor-trans'),
    path('mechanism/<int:pk>/ace_surf/', views.ace_surf, name='ace-editor-surf'),
